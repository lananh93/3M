        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function (key, value) {
                    ...
                    document.getElementById("nameCenter").style.width = value.MindMap.length*10 + 100;
                    ...
                    if (value.start.x> value.end.x) {
                        ...
                        $(".wrapper").append(
                            $('<input type="text" class="resize_left">').attr({
                                ...
                                width: value.ideas.value.length * 7 + 100,
                                position: 'absolute',
                                left: value.end.x - value.ideas.value.length * 7 + 100,
                                top: value.end.y +135
                            })
                        );
                        resize_left();
